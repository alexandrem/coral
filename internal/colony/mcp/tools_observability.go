...
func (s *Server) registerServiceHealthTool() {
	...
	// Tool definition following MCP schema from RFD 004.
	...
	s.mcpServer.RegisterTool("coral_get_service_health", toolDef, func(ctx context.Context, args map[string]interface{}) (interface{}, error) {
