		...
		SupportedModels: []ModelMetadata{
			{
				...
				Description:     "Lightweight, cost-efficient model for fast tasks",
			...
			},
			{
				...
				Description:     "Flash model with image generation capabilities",
				Capabilities:    []string{"tools", "streaming", "vision", "image-generation"},
				UseCase:         "balanced",
			...
			},
			{
				...
				Capabilities:    []string{"tools", "streaming", "vision", "reasoning"},
				UseCase:         "quality",
